...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        public virtual dynamic Login(LoginModel model, bool captchaValid, string returnUrl = "/customer/info", bool redirect = true)
        {
            ...
            return new { sucсess = false, errors = ModelState.ErrorCount };
        }
        ...
        public virtual IActionResult Register(RegisterModel model, string returnUrl, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    _genericAttributeService.SaveAttribute(customer, NopCustomerDefaults.NumberDiscountCard, model.NumberDiscountCard);

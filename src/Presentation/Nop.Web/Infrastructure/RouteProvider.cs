...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            //reviews 
            routeBuilder.MapLocalizedRoute("StoreReviews", "/reviews",
                new { controller = "Common", action = "StoreReviews" });

            //new products
            routeBuilder.MapLocalizedRoute("GetOrderImages", "order/getorderimages",
				new { controller = "Order", action = "GetOrderImages" });

			//new products
			routeBuilder.MapLocalizedRoute("ArticlesList", "/topic/articleslist",
				new { controller = "Topic", action = "ArticlesList" });

			//new products
			routeBuilder.MapLocalizedRoute("GetNewPostCost", "/Checkout/GetNewPostCost",
				new { controller = "GetNewPostCost", action = "Checkout" });
			...
			//store info
            routeBuilder.MapLocalizedRoute("StoreInfo", "storeinfo/",
			...
			//get cart
			routeBuilder.MapLocalizedRoute("GetCart", "ShoppingCart/getcart",
				new { controller = "ShoppingCart", action = "GetCart" });

			//best sellers
			routeBuilder.MapLocalizedRoute("BestSellers", "bestsellers/",
				new { controller = "Product", action = "BestSellers" });
				
			//sales products
			routeBuilder.MapLocalizedRoute("SalesProducts", "sales/",
				new { controller = "Product", action = "SalesProducts" });
